<?php
	...
	*/
	...
	require '../validaciones/conexionBD.php';
	
	/* Nombre de La Tabla */
	$sTabla = "tareas";
	
	/* Array que contiene los nombres de las columnas de la tabla*/
	$aColumnas = array( 'id_tarea', 't_tarea', 'estado', 'des_tarea', 'fecha', 'hora_i', 'hora_f', 'hora_h', 'turno', 'tecnicos', 'cargo' );
	
	/* columna indexada */
	$sIndexColumn = "id_tarea";

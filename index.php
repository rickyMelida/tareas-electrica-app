...
<!--===============================================================================================-->	
	<link rel="shortcut icon" href="./views/iconos/electrico.ico" type="image/x-icon">
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="./controller/validar_usuario.php">
					...
					<span class="login100-form-title p-b-48">
						<img src="./views/iconos/electricista.png" width="100" height="100">
					</span>
...
<!--===============================================================================================-->
	<script src="./views/js/design.js"></script>
